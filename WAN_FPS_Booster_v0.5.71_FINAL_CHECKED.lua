...
wanButton.Position = UDim2.new(0.5, 0, 0, 45)
...
local function makeDraggable(guiObject, handleObject, onMove)
    ...
    handleObject.InputBegan:Connect(function(input)
        if input.UserInputType == Enum.UserInputType.MouseButton1
            ...
            dragConnection = UserInputService.InputChanged:Connect(function(changedInput)
                ...
                local isTouchMove = changedInput.UserInputType == Enum.UserInputType.Touch
...
-- WAN: แตะเพื่อเปิด/ปิด และลากเพื่อย้ายตำแหน่ง
makeDraggable(wanButton)

-- UI หลัก: ลากได้เฉพาะส่วนหัว เพื่อไม่รบกวนปุ่มฟังก์ชันด้านใน
