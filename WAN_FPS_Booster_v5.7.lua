--==============================================================
-- WAN FPS BOOSTER
-- v0.5.70 - Fixed / Safe UI / Anti-Lag / FPS Counter / No-Dark
--==============================================================
...
-- FIX: properly closes every conditional/function block.
...
headerTitle.Text = "WAN  •  FPS Booster v0.5.70"
...
local _, switchBackground, switchKnob = createSwitch("ลดกราฟิก / ลดภาระ Render",49)
local _, fpsSwitch, fpsKnob = createSwitch("แสดง FPS",94)
local _, noDarkSwitch, noDarkKnob = createSwitch("☀️🌑🌙  ทำให้ไม่มืด",134)
