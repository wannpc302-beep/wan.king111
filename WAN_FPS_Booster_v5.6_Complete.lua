--==============================================================
-- WAN FPS BOOSTER
-- v5.6 - Complete / Safe UI / Anti-Lag / FPS Counter / No-Dark
--==============================================================
...
local function saveAndOptimize(obj)
    ...
    -- Intentionally leave PostEffect untouched in v5.6.
    -- Disabling post effects can cause visual problems and is not required here.
end
...
local function enableAntiLag()
    ...
    -- v5.6 No-Dark boundary:
    -- Anti-Lag does NOT change GlobalShadows/FogEnd and does NOT disable PostEffect.
    -- Lighting is handled only by the separate No-Dark switch.
...
local fpsLabelUI = Instance.new("TextLabel")
fpsLabelUI.Size = UDim2.new(1, -105, 0, 30)
fpsLabelUI.Position = UDim2.new(0, 15, 0, 94)
fpsLabelUI.BackgroundTransparency = 1
fpsLabelUI.Text = "แสดง FPS"
fpsLabelUI.TextColor3 = Color3.fromRGB(220, 220, 225)
fpsLabelUI.TextSize = 14
fpsLabelUI.Font = Enum.Font.Gotham
fpsLabelUI.TextXAlignment = Enum.TextXAlignment.Left
fpsLabelUI.Parent = mainFrame

local fpsSwitch = Instance.new("TextButton")
fpsSwitch.Name = "FPSSwitch"
fpsSwitch.Size = UDim2.new(0, 62, 0, 30)
fpsSwitch.Position = UDim2.new(1, -78, 0, 94)
fpsSwitch.BackgroundColor3 = Color3.fromRGB(75, 75, 80)
fpsSwitch.BorderSizePixel = 0
fpsSwitch.Text = ""
fpsSwitch.AutoButtonColor = false
fpsSwitch.Parent = mainFrame

local fpsSwitchCorner = Instance.new("UICorner")
fpsSwitchCorner.CornerRadius = UDim.new(1, 0)
fpsSwitchCorner.Parent = fpsSwitch

local fpsKnob = Instance.new("Frame")
fpsKnob.Size = UDim2.new(0, 24, 0, 24)
fpsKnob.Position = UDim2.new(0, 3, 0.5, -12)
fpsKnob.BackgroundColor3 = Color3.fromRGB(235, 235, 235)
...
local noDarkLabel = Instance.new("TextLabel")
noDarkLabel.Size = UDim2.new(1, -105, 0, 30)
noDarkLabel.Position = UDim2.new(0, 15, 0, 134)
noDarkLabel.BackgroundTransparency = 1
noDarkLabel.Text = "☀️🌑🌙  ทำให้ไม่มืด"
noDarkLabel.TextColor3 = Color3.fromRGB(220, 220, 225)
noDarkLabel.TextSize = 14
noDarkLabel.Font = Enum.Font.Gotham
noDarkLabel.TextXAlignment = Enum.TextXAlignment.Left
noDarkLabel.Parent = mainFrame

local noDarkSwitch = Instance.new("TextButton")
noDarkSwitch.Name = "NoDarkSwitch"
noDarkSwitch.Size = UDim2.new(0, 62, 0, 30)
noDarkSwitch.Position = UDim2.new(1, -78, 0, 134)
noDarkSwitch.BackgroundColor3 = Color3.fromRGB(75, 75, 80)
noDarkSwitch.BorderSizePixel = 0
noDarkSwitch.Text = ""
noDarkSwitch.AutoButtonColor = false
noDarkSwitch.Parent = mainFrame

local noDarkSwitchCorner = Instance.new("UICorner")
noDarkSwitchCorner.CornerRadius = UDim.new(1, 0)
noDarkSwitchCorner.Parent = noDarkSwitch

local noDarkKnob = Instance.new("Frame")
noDarkKnob.Size = UDim2.new(0, 24, 0, 24)
noDarkKnob.Position = UDim2.new(0, 3, 0.5, -12)
noDarkKnob.BackgroundColor3 = Color3.fromRGB(235, 235, 235)
noDarkKnob.BorderSizePixel = 0
noDarkKnob.Parent = noDarkSwitch

local noDarkKnobCorner = Instance.new("UICorner")
noDarkKnobCorner.CornerRadius = UDim.new(1, 0)
noDarkKnobCorner.Parent = noDarkKnob
...
local function updateSimpleSwitch(switch, knob, enabled, animated)
    local targetColor = enabled
        and Color3.fromRGB(50, 190, 90)
        or Color3.fromRGB(75, 75, 80)
    ...
    if animated then
        TweenService:Create(switch, switchTweenInfo, {
            BackgroundColor3 = targetColor
        }):Play()
        TweenService:Create(knob, switchTweenInfo, {
...
local function updateSwitch(animated)
    ...
    if isBoosted then
        targetColor = Color3.fromRGB(50, 190, 90)
        targetPosition = UDim2.new(1, -27, 0.5, -12)
        statusLabel.Text = "Anti-Lag: เปิด"
    else
        targetColor = Color3.fromRGB(75, 75, 80)
        targetPosition = UDim2.new(0, 3, 0.5, -12)
        statusLabel.Text = "Anti-Lag: ปิด"
    end

    if animated then
        TweenService:Create(switchBackground, switchTweenInfo, {BackgroundColor3 = targetColor}):Play()
        TweenService:Create(switchKnob, switchTweenInfo, {Position = targetPosition}):Play()
    else
        switchBackground.BackgroundColor3 = targetColor
        switchKnob.Position = targetPosition
    end
end
...
fpsSwitch.MouseButton1Click:Connect(function()
    setFPS(not fpsEnabled)
end)

noDarkSwitch.MouseButton1Click:Connect(function()
...
--==============================================================
-- DRAGGABLE UI
-- WAN button และ FPS counter สามารถลากไปวางตรงไหนก็ได้
--==============================================================
...
-- ลากกล่อง FPS ได้อิสระ ไม่ผูกกับตำแหน่ง WAN
